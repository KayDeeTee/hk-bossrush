    ...
    public class BossRushUpdate : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            {   
                ...
                if (BossInfo.isBossDead() && BossRush.gm.sceneName != "Dream_01_False_Knight" && BossRush.gm.sceneName != "Dream_02_Mage_Lord" && BossRush.gm.sceneName != "Dream_03_Infected_Knight" && BossRush.gm.sceneName != "Grimm_Nightmare")
                {
                    if (!spawnedItems)
                    {
                        BossInfo.SpawnAll();
